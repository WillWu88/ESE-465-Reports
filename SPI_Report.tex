...
\lstinputlisting[language=C]{Code/SPI/spi_interface.c}
\clearpage
\subsection{SPI Digital Logic Description}
\lstinputlisting[language=Verilog]{Code/SPI/spi.v}
\clearpage
\subsection{Waveform Diagram JSON file}
\lstinputlisting[language=python]{Code/SPI/waveform.json}
\end{document}
