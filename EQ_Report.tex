...
\lstinputlisting[language=Verilog]{Code/EQ/EQ.v}
\clearpage
\subsection{Asynchronous RAM Digital Logic Description}
\lstinputlisting[language=Verilog]{Code/EQ/async_ram.v}
\clearpage
\subsection{13-Band Parallel Filter Digital Logic Description}
\lstinputlisting[language=Verilog]{Code/EQ/Axi4LiteFIR.v}
\clearpage
\subsection{Equalizer Configuration Interface}
\lstinputlisting[language=C]{Code/EQ/eq_interface.c}
\subsection{Equalizer Graphical User Interface} 
\lstinputlisting[language=Python]{Code/EQ/eqInter.py}
\end{document}